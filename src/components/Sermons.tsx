...
const Sermons = () => {
  return (
    ...
    <div className="flex justify-between w-full">
        ...
        <img src={image10} alt="" className=" w-[69px] h-[63px] md:w-[211px] md:h-[143px]" />
            <div className="flex flex-col  justify-center gap-2">
           <p className="text-sm md:text-2xl"> Put Your Faith Into Action</p>
           <p className=" text-sm text-gray-600">By <span className="text-orange-400">Admin</span>, August 8 2025</p>
            </div>
        </div>
