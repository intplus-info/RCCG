        ...
        <main className="flex-grow relative h-[50vh] md:h-[70vh] lg:h-[80vh]">
          ...
          >
            <CarouselContent className="h-full">
              ...
              <CarouselItem className="h-full">
                <div className="flex items-center justify-center h-full mt-40 text-white px-4">
                  <div className="text-center">
                    <h1 className="text-lg md:text-4xl font-bold mb-2 md:mb-4">
                      Transforming lives
                    </h1>
                    <p className="text-2xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-8">
                      Restoring Hope
                    </p>
                  </div>
                </div>
