    ...
    <>
      ...
      >
        ...
        <div className='flex justify-between'>
          ...
          <div
            className={`flex justify-between gap-4 text-white text-0.5 cursor-pointer `}
          >
            {["home", "join", "sermons", "Events", "Give", "Gallery"].map(
              (link) => (
                <p
                  ...
                  className={`w-9 text-0.5 capitalize px-7 py-1 ${
        ...
        {sermonOpen && (
          <div className='flex flex-col justify-center items-center p-2 gap-4'>
            <hr className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></hr>
            <h1 className='text-center text-5xl text-white'>Our Sermons</h1>
            <div className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></div>
          </div>
        )}
        {joinOpen && (
          <div className='flex flex-col justify-center items-center p-2 gap-4'>
            <hr className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></hr>
            <h1 className='text-center text-5xl text-white'>Join Us</h1>
            <div className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></div>
          </div>
        )}
        {eventsOpen && (
          <div className='flex flex-col justify-center items-center p-2 gap-4'>
            <hr className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></hr>
            <h1 className='text-center text-5xl text-white'>Events</h1>
            <div className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></div>
          </div>
        )}
        {galleryOpen && (
          <div className='flex flex-col justify-center items-center p-2 gap-4'>
            <hr className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></hr>
            <h1 className='text-center text-5xl text-white'>Gallery</h1>
            <div className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></div>
          </div>
        )}
        {giveOpen && (
          <div className='flex flex-col justify-center items-center p-2 gap-4'>
            <hr className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></hr>
            <h1 className='text-center text-5xl text-white'>Giving</h1>
            <div className='w-[80vw] bg-[#FFFFFF] h-0.5 text-center'></div>
          </div>
        )}
      </div>
